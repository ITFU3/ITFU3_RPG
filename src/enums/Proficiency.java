...
// Properties
    PROPERTY_DUALHANDED("dualhanded"),
    PROPERTY_SINGLEHANDED("singelhanded"),
    PROPERTY_VERSITILE("versitile"),
    PROPERTY_THROWABLE("throwable"),
    PROPERTY_REACH("reach"),//=> distance of 2
    
// Spell Effect
    SPELLEFFECT_DAMAGE("damage"),
